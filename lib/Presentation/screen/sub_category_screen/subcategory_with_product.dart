/*
// Main screen class with new name
...
class SubcategoryWithProduct extends StatefulWidget {
   SubcategoryWithProduct({super.key});
    ...
    return FutureBuilder<List<SubcategoryData>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            return Center(
                child: SpinKitFadingCircle(color: Colors.blueAccent.shade400));
          ...
          //           context,
          //           MaterialPageRoute(
          //             builder: (_) => ProductScreen_sub(subcategoryId: sub.id),
          //           ),
          //         );
          //       },
          //     );
