...
class SubcategoryIconPage extends ConsumerStatefulWidget {
  ...
  const SubcategoryIconPage({super.key, required this.categoryName});
...
class _SubcategoryIconPageState extends ConsumerState<SubcategoryIconPage> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<SubcategoryData>>(
      ...
      builder: (context, snapshot) {
        ...
        final subcategories = snapshot.data!.take(12).toList();
          ...
          sliver: SliverGrid(
            ...
            delegate: SliverChildBuilderDelegate((context, index) {
              ...
              return GestureDetector(
                onTap: () {
                  final repository = ref.read(userAuthRepositoryProvider);
