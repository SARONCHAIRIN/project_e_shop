...
class AddAddressPage extends StatefulWidget {
  ...
  const AddAddressPage({super.key, required this.repo, required this.storage});
...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  Widget _BuildSaveAddress() => Padding(
    ...
    child: Container(
      child: is_loading ? _buildaftersave() : _buildbeforeSave(),
    ),
  );

  //before save
  Widget _buildaftersave() => Padding(
