...
class MobileScreen extends ConsumerStatefulWidget {
  ...
  const MobileScreen({super.key, required this.userId, required this.token});

  @override
  ConsumerState<MobileScreen> createState() => _CartScreenState();
}

class _CartScreenState extends ConsumerState<MobileScreen> {
  @override
  void initState() {
    super.initState();
