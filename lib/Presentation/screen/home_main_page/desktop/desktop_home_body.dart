...
class DesktopHomeBody extends ConsumerStatefulWidget {
  final HomeViewArgs args;

  const DesktopHomeBody({super.key, required this.args});

  @override
  ConsumerState<DesktopHomeBody> createState() => _DesktopHomeBodyState();
}

class _DesktopHomeBodyState extends ConsumerState<DesktopHomeBody> {
  ...
  Future<void> _loadCategories() async {
    try {
      ...
      debugPrint("Desktop Load Category Error: $e");
          ...
          _chip(
            ...
            onTap: () {
              setState(() {
                ...
                debugPrint("DESKTOP CATEGORY FILTER ID: ALL");
              });
            },
          ),
              ...
              child: _chip(
                ...
                onTap: () {
                  setState(() {
                    ...
                    debugPrint("DESKTOP CATEGORY FILTER ID: ${category.id}");
                  });
                },
              ),
            );
          ...
          child: Container(
            ...
            child: CustomScrollView(
              ...
              slivers: [
                ...
                // Assuming IconSubWithProduct returns a Sliver or SliverList/SliverGrid directly.
                // If it returns a standard box widget (like Column or Container), wrap it in SliverToBoxAdapter.
                IconSubWithProduct(
                ...
                // Assuming SubcategoryWithProduct returns a Sliver/SliverGrid directly.
                // If it returns a standard widget, wrap it in SliverToBoxAdapter.
