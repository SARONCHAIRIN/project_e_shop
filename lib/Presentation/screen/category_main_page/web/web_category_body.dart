...
class WebCategoryBody extends ConsumerStatefulWidget {
  final dynamic authRepository;

  const WebCategoryBody({super.key, required this.authRepository});

  @override
  ConsumerState<WebCategoryBody> createState() => _WebCategoryBodyState();
}

class _WebCategoryBodyState extends ConsumerState<WebCategoryBody> {
