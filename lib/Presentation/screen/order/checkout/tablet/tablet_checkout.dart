...
class TabletCheckout extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TabletCheckout> createState() => _CheckoutPageState();
}

class _CheckoutPageState extends ConsumerState<TabletCheckout> {
  int currentStep = 0;
