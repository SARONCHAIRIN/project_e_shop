...
//   }
//   Future<void> _uploadImagetoprofile() async {
...
//
//       final uri = Uri.parse(
//         "https://e-shop-1-m034.onrender.com/api/v1/user/id/image?id=$userId",
//       );
//
...
//
//         final imageUrl = data['data']?['image'];
//
//         if (imageUrl != null) {
//           setState(() {
...
//           });
//
//           await storage.writeUserImage(imageUrl);
//
//           _showSnackBar("Upload successful");
//         }
//       } else if (response.statusCode == 401) {
//         _showSnackBar("Unauthorized", isError: true);
//       } else {
