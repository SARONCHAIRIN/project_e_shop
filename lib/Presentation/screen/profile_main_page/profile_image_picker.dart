...
//             _image = null; // Clear local image to show uploaded one
//           });
//           // _uploadedImageUrl = data['data']['image'];
//
//           final storage = TokenStorage();
...
//         } else {
//           _showSnackBar("Upload failed: Invalid response", isError: true);
//         }
...
//                       icon: Icon(
//                         Icons.camera_alt, size: 26, color: Colors.blue,),
//                     ),
//                   ),
//                 ),
//
...
//           // imageUrl: "${_uploadedImageUrl!}?v=${DateTime
//           //     .now()
...
//                   ),
//                   hintText: "${user?.email.isNotEmpty == true
//                       ? user!.email
//                       : 'No data'}",
//                   hintStyle: TextStyle(
//                     color: Colors.black,
